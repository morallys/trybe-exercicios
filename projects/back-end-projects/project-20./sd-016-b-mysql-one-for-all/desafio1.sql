...
CREATE TABLE IF NOT EXISTS SpotifyClone.`Usuarios` (
  ...
  `Planos_plano_id` INT NOT NULL,
    FOREIGN KEY (`Planos_plano_id`) REFERENCES SpotifyClone.`Planos` (`plano_id`)
) ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table SpotifyClone.`Relacao_artistas_seguidos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS SpotifyClone.`Relacao_artistas_seguidos` (
  `Usuarios_usuario_id` INT NOT NULL,
  `Artistas_artista_id` INT NOT NULL,
    PRIMARY KEY (`Usuarios_usuario_id`, `Artistas_artista_id`),
    FOREIGN KEY (`Usuarios_usuario_id`) REFERENCES SpotifyClone.`Usuarios` (`usuario_id`),
    FOREIGN KEY (`Artistas_artista_id`) REFERENCES SpotifyClone.`Artistas` (`artista_id`)
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS SpotifyClone.`Cancoes` (
  ...
  `Albuns_album_id` INT NOT NULL,
    FOREIGN KEY (`Albuns_album_id`) REFERENCES SpotifyClone.`Albuns` (`album_id`)
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS SpotifyClone.`Historico_reproducao` (
  `Usuarios_usuario_id` INT NOT NULL,
  `Cancoes_cancoes_id` INT NOT NULL,
  `data_reproducao` DATETIME NOT NULL,
    PRIMARY KEY (`Usuarios_usuario_id`, `Cancoes_cancoes_id`),
    FOREIGN KEY (`Usuarios_usuario_id`) REFERENCES SpotifyClone.`Usuarios` (`usuario_id`),
    FOREIGN KEY (`Cancoes_cancoes_id`) REFERENCES SpotifyClone.`Cancoes` (`cancoes_id`)
) ENGINE = InnoDB;
...
INSERT INTO SpotifyClone.Usuarios (usuario_nome, usuario_idade, data_assinatura, Planos_plano_id)
VALUES
...
INSERT INTO SpotifyClone.Relacao_artistas_seguidos (Usuarios_usuario_id, Artistas_artista_id)
VALUES
  (1, 1),
  (1, 2),
  (1, 3),
...
INSERT INTO SpotifyClone.Albuns (album_nome, Artistas_artista_id, ano_lancamento)
VALUES
  ('Envious', 1, 1990),
  ('Exuberant',  1, 1993),
...
INSERT INTO SpotifyClone.Cancoes (cancoes_nome, duracao_musica, Albuns_album_id)
VALUES
  ('Soul For Us', 200, 1),
...
INSERT INTO SpotifyClone.Historico_reproducao (Usuarios_usuario_id, Cancoes_cancoes_id, data_reproducao)
VALUES
