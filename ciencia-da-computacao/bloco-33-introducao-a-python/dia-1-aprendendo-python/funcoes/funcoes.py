...
# e os parâmetros entre parênteses.
...
def imc(peso, altura):
    return print(peso / (altura / 100) ** 2)


# imc(altura=179, peso=86)
imc(86, 179)


# Os parâmetros também podem ser variádicos, ou seja, variam em sua quantidade.

# Anota aí ✏️: Parâmetros posicionais variádicos são acessados como uma tupla
# no interior de uma função, e parâmetros nomeados variádicos como
# um dicionário.
