# Exercício 13: Um sistema de avaliações registra valores de 0 a 10
...
# avaliações ratings = [6, 8, 5, 9, 10]. Escreva um código capaz de
# gerar as avaliações após a mudança. Neste caso o resultado deveria
# ser [60, 80, 50, 90, 100].
