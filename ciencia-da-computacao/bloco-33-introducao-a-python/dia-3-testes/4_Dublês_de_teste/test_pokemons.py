# SECTION -  Primeiro cenário de testes
...
# # Cria-se o contexto de um pokemon do tipo grama
# @pytest.fixture
...
# # Cria-se o contexto de um pokemon do tipo água
# @pytest.fixture
...
#     # Cria um arquivo em memória que o seu conteúdo são os dois pokemons
#     fake_file = StringIO(
...
# SECTION -  Segundo cenário de testes
...
def test_retrieve_pokemons_by_type():
    ...
    with patch("builtins.open", mock_open(read_data=pokemon_json_content)):
        ...
        assert retrive_pokemons_by_type("Grass", "dummy") == [grass_type_pokemon]
